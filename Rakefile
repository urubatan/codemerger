...
Jeweler::Tasks.new do |gem|
  ...
  gem.license = "MIT"
  gem.summary = %Q{Used to create blog posts and tecnical articles that need code samples, the code samples will be taken from the actual source code file instead of a copy paste approach}
  gem.description = %Q{This gem is used to help writing technical posts for wordpress.
